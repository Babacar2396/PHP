            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/classes/liste/<?php echo $classe['id_classe']; ?>" class="btn btn-primary mt-4">Bulletins eleves</a> 
                        <a href="/classes/coef/<?php echo $classe['id_classe']; ?>" class="btn btn-primary mt-4">Disciplines</a>      
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
