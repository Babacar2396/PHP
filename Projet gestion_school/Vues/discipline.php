                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" name="module" id="disci" placeholder="Ex: Science">
                            <div class="input-group-append">
                  ...
                  <div class="form-group">
                    <div class="form-group">
                        ...
                        <div style="margin-top: 50px; background-color: aqua; width: 1100px; height: 300px;" id="disciplines-container" class="row justify-content-center">
                         ...
                         <button id="update-button" class="btn btn-primary btn-large" style="margin-right: -1400px;">Mettre a jour</button>
